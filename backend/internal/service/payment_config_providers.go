...
var providerPendingOrderProtectedConfigFields = map[string]map[string]struct{}{
	...
	payment.TypePay2S:     {"partnercode": {}, "accesskey": {}, "secretkey": {}},
}
...
var validProviderKeys = map[string]bool{
	payment.TypeEasyPay: true, payment.TypeAlipay: true, payment.TypeWxpay: true, payment.TypeStripe: true, payment.TypeAirwallex: true, payment.TypePay2S: true,
}
