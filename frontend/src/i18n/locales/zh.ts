export default {
    ...
    accounts: {
      ...
      oauth: {
        ...
        openai: {
          ...
          codexSessionDesc:
            "粘贴 Codex JSON 或 accessToken，按第一步配置创建账号。",
      ...
      features: {
        ...
        affiliate: {
          ...
          modal: {
            ...
            codeHint:
              "4-32 位，仅支持大写字母、数字、下划线、连字符；留空表示不修改；输入将自动转大写。",
            rateLabel: "专属返利比例（可选）",
  ...
  payment: {
    ...
    fee: "手续费",
    actualPay: "实付金额",
    pay2sVndEquivalent: "越南盾等价",
    pay2sVndEquivalentTopup: "充值越南盾等价",
    pay2sVndEquivalentSubscribe: "订阅越南盾等价",
    pay2sExchangeRate: "汇率: 27,000 越南盾 = 1 美元",
    createOrder: "确认支付",
    methods: {
      easypay: "易支付",
      alipay: "支付宝",
