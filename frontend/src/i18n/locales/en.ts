export default {
  ...
  admin: {
    ...
    affiliates: {
      ...
      rebatesDescription:
        "View recharge orders that generated affiliate rebates",
      transfersDescription:
        "View affiliate quota transfers into account balance",
      errors: {
    ...
    riskControl: {
      ...
      workerStatusHint:
        "Queue and worker pool status for asynchronous observation tasks.",
    ...
    accounts: {
      ...
      openai: {
        ...
        codexImageGenerationBridgeInheritDesc:
          "Do not write an account override; use the channel or global policy.",
        codexImageGenerationBridgeEnabled: "Force on",
        codexImageGenerationBridgeEnabledDesc:
          "Allow image tool injection for Codex /responses requests.",
        codexImageGenerationBridgeDisabled: "Force off",
        codexImageGenerationBridgeDisabledDesc:
          "Block image tool injection for Codex /responses requests.",
      ...
      oauth: {
        ...
        openai: {
          ...
          codexSessionDesc:
            "Paste Codex JSON or an accessToken. Accounts use the step 1 settings.",
          codexSessionInputLabel: "Codex JSON or accessToken",
          codexSessionPlaceholder:
            "Multiple lines supported, one token or JSON per line",
          codexSessionHint:
    ...
    settings: {
      ...
      features: {
        ...
        riskControl: {
          title: "Risk Control",
          description:
            "Enable the content moderation menu and gateway audit entry point. Disabled by default.",
          configureLink: "Configure content moderation in Risk Control",
          enabled: "Enable Risk Control",
          enabledHint:
            "When off, the admin sidebar entry is hidden and gateway moderation is skipped.",
        },
        affiliate: {
          ...
          rebateRateHint:
            "Default percentage given back to the inviter on recharges (0-100, e.g. 10 = 10%).",
          ...
          perInviteeCapDesc:
            "Maximum total rebate from a single invitee. 0 = no limit.",
          customUsers: {
          ...
          modal: {
            ...
            codeHint:
              "4-32 characters; A-Z, 0-9, underscore, dash. Leave empty to keep current. Input is upper-cased.",
            rateLabel: "Exclusive Rebate Rate (optional)",
            ratePlaceholder: "e.g. 30",
            rateHint:
              "0-100. Leave empty (in edit mode) to clear and fall back to the global rate.",
            errorBadRate: "Please enter a number between 0 and 100",
            errorEmpty:
              "Fill at least one: custom invite code or exclusive rebate rate",
          },
          batchModal: {
            ...
            placeholder: "e.g. 30",
            clearHint:
              "Submitting empty will clear the exclusive rate for selected users.",
          },
        },
      },
  ...
  payment: {
    ...
    pay2sVndEquivalent: "VND Equivalent",
    pay2sVndEquivalentTopup: "Recharge VND Equivalent",
    pay2sVndEquivalentSubscribe: "Subscription VND Equivalent",
    pay2sExchangeRate: "Exchange rate: 27,000 VND = 1 USD",
