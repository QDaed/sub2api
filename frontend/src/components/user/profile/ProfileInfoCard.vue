          ...
          <div class="min-w-0 flex-1 space-y-5">
            <div class="space-y-3">
              <div class="flex flex-wrap items-center gap-2">
                <h2
                  class="truncate text-2xl font-semibold text-gray-900 dark:text-white"
                >
                  {{ displayName }}
                </h2>
                <span
            ...
            <div class="grid gap-3 sm:grid-cols-3">
              ...
              >
                <p
                  class="text-xs font-medium uppercase tracking-[0.16em] text-gray-400 dark:text-gray-500"
                >
      ...
      <div data-testid="profile-main-column" class="space-y-6">
        ...
        >
          ...
          <div class="grid gap-6 sm:grid-cols-1 md:grid-cols-2">
            <div
              class="rounded-3xl border border-gray-100 bg-gray-50/80 p-5 dark:border-dark-700 dark:bg-dark-900/30"
            >
        ...
        <!-- Identity bindings section hidden -->
      </div>
          ...
          <div class="mt-5 grid gap-3">
            ...
            >
              <Icon
                name="link"
                size="sm"
                class="mt-0.5 text-gray-400 dark:text-gray-500"
              />
              <span>{{ hint.text }}</span>
            </div>
          </div>
