...
export const WEBHOOK_PATHS: Record<string, string> = {
  ...
  pay2s: "/api/v1/payment/webhook/pay2s",
};
...
export const PROVIDER_CALLBACK_PATHS: Record<string, CallbackPaths> = {
  ...
  pay2s: { notifyUrl: WEBHOOK_PATHS.pay2s, returnUrl: RETURN_PATH },
};
...
export const PROVIDER_CONFIG_FIELDS: Record<string, ConfigFieldDef[]> = {
  ...
  airwallex: [
    ...
    { key: "webhookSecret", label: "", sensitive: true },
    {
      ...
      label: "",
      sensitive: false,
      defaultValue: "https://api.airwallex.com/api/v1",
      hintKey: "admin.settings.payment.field_airwallexApiBaseHint",
    },
    { key: "countryCode", label: "", sensitive: false, defaultValue: "VN" },
    {
      key: "currency",
      label: "",
      sensitive: false,
    ...
    },
    {
      ...
      optional: true,
      clearable: true,
      hintKey: "admin.settings.payment.field_accountIdHint",
    },
  ],
  pay2s: [
    { key: "partnerCode", label: "Partner Code", sensitive: false },
    { key: "accessKey", label: "Access Key", sensitive: false },
    { key: "secretKey", label: "Secret Key", sensitive: false },
    {
      key: "environment",
      label: "Environment",
      sensitive: false,
    ...
    },
    {
      ...
      sensitive: false,
      optional: true,
      hintKey: "admin.settings.payment.field_pay2sBankAccountsHint",
    },
    {
      key: "bankId",
      label: "Bank ID",
      sensitive: false,
      optional: true,
      hintKey: "admin.settings.payment.field_pay2sBankIdHint",
    },
    {
      key: "partnerName",
      label: "Partner Name",
