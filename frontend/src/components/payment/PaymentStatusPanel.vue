  ...
  <div class="space-y-4">
    ...
    <template v-if="outcome === 'success'">
      <div class="card p-6">
        <div class="flex flex-col items-center space-y-4 py-4">
          ...
          <div
            v-if="paidOrder"
            class="w-full rounded-xl bg-gray-50 p-4 dark:bg-dark-800"
          >
    ...
    <template v-else-if="qrUrl">
      <div class="card p-6">
        <div class="flex flex-col items-center space-y-4">
          ...
          <div :class="['relative rounded-lg border-2 p-4', qrBorderClass]">
            <!-- Image QR (e.g. Pay2S base64 or URL) -->
            <img
              v-if="isImageQr"
              :src="qrUrl"
              alt="Payment QR"
            ...
            />
            <!-- Canvas QR for raw string data -->
            <canvas v-else ref="qrCanvas" class="mx-auto"></canvas>
            <!-- Brand logo overlay (Alipay / WeChat only) -->
            <div
              v-if="isAlipay || isWxpay"
      ...
      <div class="card p-4 text-center">
        ...
        <p
          class="mt-1 text-2xl font-bold tabular-nums text-gray-900 dark:text-white"
        >
          {{ countdownDisplay }}
        </p>
...
const qrBorderClass = computed(() => {
  if (isAlipay.value)
    return "border-[#00AEEF] bg-blue-50 dark:border-[#00AEEF]/70 dark:bg-blue-950/20";
  if (isWxpay.value)
    return "border-[#2BB741] bg-green-50 dark:border-[#2BB741]/70 dark:bg-green-950/20";
