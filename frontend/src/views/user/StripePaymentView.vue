<template>
  <component
    ...
    :class="isPopup ? 'min-h-screen bg-gray-50 dark:bg-dark-900' : ''"
  >
    <div class="mx-auto max-w-lg space-y-6 py-8" :class="isPopup ? 'px-4' : ''">
      ...
      <template v-else>
        ...
        <div v-if="order" class="card overflow-hidden">
          <div
            class="bg-gradient-to-br from-[#635bff] to-[#4f46e5] px-6 py-6 text-center"
          >
        ...
        <template v-if="wechatQrUrl">
          <div class="card p-6">
            <div class="flex flex-col items-center space-y-4">
              ...
              <div
                class="relative rounded-lg border-2 border-[#2BB741] bg-green-50 p-4 dark:border-[#2BB741]/70 dark:bg-green-950/20"
              >
                <img
                  :src="wechatQrUrl"
                  alt="WeChat Pay QR"
                ...
                >
                  <span
                    class="rounded-full bg-[#2BB741] p-2 shadow ring-2 ring-white"
                  >
                    <svg
